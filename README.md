...
생성과 운영이 쉬워 우후죽순 생겨난 커뮤니티 중에는 운영자가 불어난 카페의 몸집을 감당할만한 자격이 되지 않는 경우가 있고, 그 결과로 인터넷 독재와 카페 매각이라는 부적절한 행동을 저질러 방대한 데이터가 유실되는 경우도 있습니다.       
...
현재 배포되는 배포판은 파이썬의 기본 프로그램인 idle에서 돌아가고, 대부분의 외부 프로그램들을 내장해서 따로 설치할 프로그램은 없습니다. 크롬 빼구요.    
