...
try:
	driver = webdriver.Chrome(executable_path="C:/Users/%s/NCBP/programdata/chromedriver_76.exe" % username)
	driver.implicitly_wait(1)
	driver.get("https://naver.com")
except:
	try:
		time.sleep(3)
		driver = webdriver.Chrome(executable_path="C:/Users/%s/NCBP/programdata/chromedriver_75.exe" % username)
		driver.implicitly_wait(1)
		driver.get("https://naver.com")
	except:
		try:
			time.sleep(3)
			driver = webdriver.Chrome(executable_path="C:/Users/%s/NCBP/programdata/chromedriver_74.exe" % username)
			driver.implicitly_wait(1)
			driver.get("https://naver.com")
		except:
			print('프로그램 초기화에 실패했습니다')
