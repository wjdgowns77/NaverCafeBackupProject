...
COPY "programdata\chromedriver_84.exe" "C:\Users\%username%\NCBP\programdata\chromedriver_84.exe"
COPY "programdata\chromedriver_85.exe" "C:\Users\%username%\NCBP\programdata\chromedriver_85.exe"
...
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_83.exe" (
	...
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_84.exe" (
	ECHO 파일 복사 오류!
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_85.exe" (
	ECHO 파일 복사 오류!
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
