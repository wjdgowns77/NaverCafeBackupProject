...
COPY "programdata\chromedriver_74.exe" "C:\Users\%username%\NCBP\programdata\chromedriver_74.exe"
COPY "programdata\chromedriver_75.exe" "C:\Users\%username%\NCBP\programdata\chromedriver_75.exe"
COPY "programdata\chromedriver_76.exe" "C:\Users\%username%\NCBP\programdata\chromedriver_76.exe"
COPY "programdata\chromedriver_77.exe" "C:\Users\%username%\NCBP\programdata\chromedriver_77.exe"
COPY "programdata\chromedriver_78.exe" "C:\Users\%username%\NCBP\programdata\chromedriver_78.exe"
COPY "programdata\chromedriver_79.exe" "C:\Users\%username%\NCBP\programdata\chromedriver_79.exe"
...
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\NCBP_WK.bat" (
	...
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_74.exe" (
	ECHO 파일 복사 오류!
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_75.exe" (
	ECHO 파일 복사 오류!
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_76.exe" (
	ECHO 파일 복사 오류!
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_77.exe" (
	ECHO 파일 복사 오류!
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_78.exe" (
	ECHO 파일 복사 오류!
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
IF NOT EXIST "C:\Users\%username%\NCBP\programdata\chromedriver_79.exe" (
	ECHO 파일 복사 오류!
	ECHO 설치오류! NCBP.NoNaver.Com에 있는 "오류>파일복사오류"항목을 참고하여 파일을 수동 이동하세요.
	PAUSE)
timeout 1
