...
try:
	driver = webdriver.Chrome(executable_path="C:/Users/%s/NCBP/programdata/chromedriver_79.exe" % username)
	driver.implicitly_wait(1)
	driver.get("https://naver.com")
except:
	try:
		time.sleep(3)
		driver = webdriver.Chrome(executable_path="C:/Users/%s/NCBP/programdata/chromedriver_78.exe" % username)
		driver.implicitly_wait(1)
		driver.get("https://naver.com")
	except:
		try:
			time.sleep(3)
			driver = webdriver.Chrome(executable_path="C:/Users/%s/NCBP/programdata/chromedriver_77.exe" % username)
			driver.implicitly_wait(1)
			driver.get("https://naver.com")
		except:
